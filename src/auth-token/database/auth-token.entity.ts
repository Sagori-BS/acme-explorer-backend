...
import { AuthTokenTypes } from '../../../../../../libs/common/src/graphql/enums/auth-token-types.enum';
import { validateToken } from '@common/common/validations/entities/token/token.validator';
