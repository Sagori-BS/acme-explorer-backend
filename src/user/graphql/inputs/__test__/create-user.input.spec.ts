...
describe('CreateUserInput', () => {
  ...
  describe('Valid inputs', () => {
    it('should successfully validate the input', () => {
      ...
      // Act
      const { error, value } =
        CreateEntityInput.validationSchema.validate(input);
  ...
  describe('Invalid inputs', () => {
    ...
    describe('roles', () => {
      it('should return error when roles is undefined', () => {
        const input = {
          ...createEntityInput,
          roles: undefined
        };
      ...
      it('should return error when roles is null', () => {
        const input = {
          ...createEntityInput,
          roles: null
        };
      ...
      it('should return error when roles is invalid', () => {
        const input = {
          ...createEntityInput,
          roles: [faker.lorem.paragraphs(100)]
        };
