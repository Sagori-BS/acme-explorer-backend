...
import { validateAddressNullable } from '@common/common/validations/entities/location/address/address-nullable.validator';
import { validateTelephoneNumberNullable } from '@common/common/validations/entities/user/telephone-number/telephone-number-nullable.validator';
import { UserRoles } from '@common/common/auth/enums/user-roles.enum';
import { validateUserRoles } from '@common/common/validations/entities/user/user-roles/user-roles.validator';
